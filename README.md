...
If you prefer to build, install, and capture logs from Windows PowerShell (outside Android Studio) see `README-TESTING-POWERSHELL.md` at the project root for exact commands and troubleshooting notes.
